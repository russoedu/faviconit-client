export const el = {
  ...
  formFileHelp:               'Η εικόνα πρέπει να είναι <strong>τουλάχιστων {{size}}x{{size}}px</strong> μέ <strong>ανώτατο όριο {{max}}MB</strong></strong>',
  ...
  validation: {
    ...
    squared_image:      'Τό {{attribute}} πρέπει να είναι <strong>τετράγωνο</strong> με τουλάχιστον 310px. <a href=\'https://picresize.com/\' target=\'_blamk\'>CROP HERE</a>',
    squared_image_old:  'Τό {{attribute}} πρέπει να είναι <strong>τετράγωνο</strong> με τουλάχιστον 310px. Ανεβάστε την εικόνα σας και πατήστε στο \'επεξεργασία εικόνας\' για να την περικόψετε. ',
    minimum_size_image: 'Το <strong>favicon αρχείο</strong> πρέπει να έχει τουλάχιστον 200px σε κάθε διάσταση. παρακαλώ, ανεβάστε μία μεγαλύτερη εικόνα.',
    attributes:         {
      iconName:     '<strong>Όνομα favicon</strong>',
      iconVersion:  '<strong>favicon έκδοση</strong>',
      iconFile:     '<strong>favicon αρχείο</strong>',
      iconImage:    '<strong>favicon αρχείο</strong>',
      iconLocation: '<strong>favicon φάκελος</strong>',
    },
  },
}